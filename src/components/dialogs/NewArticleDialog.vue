...
export default {
  ...
  methods: {
    ...
    articleExists(article) {
      ...
      console.log('article exists in repo', article.metadata, this.dataset)
      axios.patch(
          article.links.self,
          [{
            op: 'add',
            ...
            value: {
              ...
              'oarepo:draft': this.dataset.metadata['oarepo:draft']
            }
    ...
    updateDatasetArray(article, dataset) {
      console.log('update datasets', dataset)
      article.datasets.push({
        pid_value: dataset.id,
        'oarepo:draft': dataset.metadata['oarepo:draft']
      })
    },
    updateArticle() {
